...
показано выше), так как относительный путь вычисляется от места вызова Node.js
процесса, что часто отличается от расположения файла в котором была использована
данная утилита.
